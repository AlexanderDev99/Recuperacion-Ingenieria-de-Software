...
public class MetricController {
     ...
     * El classId se obtiene internamente del scheduler, NO del request.
     */
    // 2. Solo ponemos la parte final de la ruta
    @PostMapping("/create") 
    public ResponseEntity<Metric> createMetric(@Valid @RequestBody MetricsDTO metricsDTO) {
        Metric savedMetric = metricService.saveMetric(metricsDTO);
